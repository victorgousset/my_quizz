...
return [
    ...
    'app_question_selectxquestion' => [['categorie'], ['_controller' => 'App\\Controller\\QuestionController::selectXQuestion'], [], [['variable', '/', '[^/]++', 'categorie', true]], [], []],
    'app_question_getxquestion' => [['categorie', 'nombre'], ['_controller' => 'App\\Controller\\QuestionController::getXQuestion'], [], [['variable', '/', '[^/]++', 'nombre', true], ['variable', '/', '[^/]++', 'categorie', true]], [], []],
