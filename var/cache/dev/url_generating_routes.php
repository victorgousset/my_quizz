...
return [
    ...
    'app_admin_quizzlist' => [[], ['_controller' => 'App\\Controller\\AdminController::quizzlist'], [], [['text', '/admin/quizzlist']], [], []],
    'app_admin_deletequizz' => [['id'], ['_controller' => 'App\\Controller\\AdminController::deleteQuizz'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/admin/quizz/supprimer']], [], []],
    ...
    'id' => [['id'], ['_controller' => 'App\\Controller\\QuestionController::index'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/list']], [], []],
    'app_question_selectxquestion' => [['categorie'], ['_controller' => 'App\\Controller\\QuestionController::selectXQuestion'], [], [['variable', '/', '[^/]++', 'categorie', true], ['text', '/question']], [], []],
    'app_question_getxquestion' => [['categorie', 'nombre'], ['_controller' => 'App\\Controller\\QuestionController::getXQuestion'], [], [['variable', '/', '[^/]++', 'nombre', true], ['variable', '/', '[^/]++', 'categorie', true], ['text', '/qquestion']], [], []],
    'app_question_getquestion' => [['categorie', 'nombre'], ['_controller' => 'App\\Controller\\QuestionController::getQuestion'], [], [['variable', '/', '[^/]++', 'nombre', true], ['variable', '/', '[^/]++', 'categorie', true], ['text', '/question']], [], []],
