...
return [
    ...
    'app_question_getxquestion' => [['categorie', 'nombre'], ['_controller' => 'App\\Controller\\QuestionController::getXQuestion'], [], [['variable', '/', '[^/]++', 'nombre', true], ['variable', '/', '[^/]++', 'categorie', true], ['text', '/question']], [], []],
